...
const models: TsoaRoute.Models = {
    ...
    "ItemUpdateParams": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"isDone":{"dataType":"boolean"},"content":{"dataType":"string"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "User": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/v1/users',
            ...
            async function UserController_getAllUsers(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/v1/users/:id',
            ...
            async function UserController_getUserById(request: any, response: any, next: any) {
            const args = {
